...
public abstract class TCPImplementation extends ProtocolImplementation {

   private Identity portNumber = new Identity("portNumber", this);

   protected TCPImplementation(String name, Asset superAsset, ProtocolType protocolType) {
